        ...
        <ul class="main-buttons">
          ...
          <li>
			...
			while ($line = pg_fetch_array($res, null, PGSQL_ASSOC)) {
    			$result.='
					  <li> <a href="?psd='.$line["branchcl"].'">'.$line["branchcl"].' </a></li>';
